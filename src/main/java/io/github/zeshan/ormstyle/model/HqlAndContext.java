...
import static io.github.zeshan.ORMStyle.parser.EntityParser.findCalledIn;
import static io.github.zeshan.ORMStyle.utils.Const.*;public class HqlAndContext implements Serializable {
    String id;
    List<String> hql;
    String returnType;
    String methodName;
